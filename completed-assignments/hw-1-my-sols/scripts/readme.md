## Junction-tree message passing implementations for inference in a toy Bayesian network; and for unsupervised parameter estimation in hidden Markov models (HMMs) with a toy dataset.
